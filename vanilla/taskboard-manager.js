...
var BoardSettingsElement = class extends HTMLElement {
  ...
  #createList(taskList, taskSettings) {
    ...
    const tasklistExportParts = new Set([...taskListElement.shadowRoot.querySelectorAll("[id],[class]")].map((item) => {
