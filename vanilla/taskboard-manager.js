...
var taskboard_manager_default = `:host\r
{    \r
    font: inherit;\r
    display: grid;\r
    border: solid 1px;\r
...
var ImportManagerComponent = class extends HTMLElement {
  ...
  findPart(key) {
    return this.querySelector(`[part="${key}"]`);
  }
  ...
  setData(boardData) {
    ...
    this.findPart("import-preview").setData(modifiedData);
  }
  ...
  getRecord() {
    const data = this.findPart("import-preview").getUpdatedData();
    return data;
  }
};
...
// node_modules/.pnpm/@magnit-ce+editable-list@0.0.8/node_modules/@magnit-ce/editable-list/dist/editable-list.mjs
...
COMPONENT_STYLESHEET5.replaceSync(STYLE);
var COMPONENT_TAG_NAME5 = "editable-list";
...
if (customElements.get(COMPONENT_TAG_NAME5) == null) {
  customElements.define(COMPONENT_TAG_NAME5, EditableListElement);
}
...
var COMPONENT_TAG_NAME6 = "route-dialog";
var RouteDialogElement = class extends RouteType(HTMLDialogElement) {
};
if (customElements.get(COMPONENT_TAG_NAME6) == null) {
  customElements.define(COMPONENT_TAG_NAME6, RouteDialogElement, { extends: "dialog" });
}
...
COMPONENT_STYLESHEET6.replaceSync(path_router_default);
...
var PathRouterElement = class extends HTMLElement {
  ...
  get routeDialogs() {
    return Array.from(this.querySelectorAll(`:scope > [is="${COMPONENT_TAG_NAME6}"]`), (routeDialog) => routeDialog);
  }
  get routes() {
    return Array.from(this.querySelectorAll(`:scope > ${COMPONENT_TAG_NAME22},${COMPONENT_TAG_NAME32} :not(${COMPONENT_TAG_NAME32}) ${COMPONENT_TAG_NAME22},:scope > [is="${COMPONENT_TAG_NAME6}"]`), (route) => route);
  }
  ...
  async #update(path, previousPath) {
    ...
    if (pageHasChanged || currentDialogPath != dialogPath) {
      ...
      if (closed != false) {
        ...
        for (let i = 0; i < matchingPageRoutes.length; i++) {
          const routeData = matchingPageRoutes[i];
          if (routeData.route.closest(`[is="${COMPONENT_TAG_NAME6}"][open]`) != null) {
            openPagePromise = this.#openRoutePage(routeData.route, dialogPath);
            this.#assignRouteProperties(routeData.route, routeData.properties);
          }
        }
  ...
  routeMatchesPath(route, queryPath, previousMatches, isDialog = false) {
    ...
    const pathType = route.closest(`[is="${COMPONENT_TAG_NAME6}"]`) == null ? "Page" : "Dialog";
    if (pathType == "Page") {
    ...
    return this.routeTypeMatches(route, dialogPathArray, routePathArray, `${COMPONENT_TAG_NAME22},[is="${COMPONENT_TAG_NAME6}"]`, previousMatches);
  }
  ...
  #injectStyles() {
    let parent = this.getRootNode();
    if (parent.adoptedStyleSheets.indexOf(COMPONENT_STYLESHEET6) == -1) {
      parent.adoptedStyleSheets.push(COMPONENT_STYLESHEET6);
    }
  }
...
// node_modules/.pnpm/@magnit-ce+task-board@0.0.2/node_modules/@magnit-ce/task-board/dist/task-board.js
var COMPONENT_STYLESHEET7 = new CSSStyleSheet();
COMPONENT_STYLESHEET7.replaceSync(`
:host
{
    overflow: hidden;
    display: flex;
...
`);
var COMPONENT_TAG_NAME7 = "task-board";
...
var COMPONENT_TAG_NAME8 = "task-list";
  ...
  constructor() {
    ...
    this.shadowRoot.querySelector("slot:not([name])").addEventListener("slotchange", (event) => {
      ...
      for (let i = 0; i < children.length; i++) {
        ...
        if (children[i].tagName.toLowerCase() == COMPONENT_TAG_NAME8.toLowerCase()) {
...
// node_modules/.pnpm/@magnit-ce+task-card@0.0.3/node_modules/@magnit-ce/task-card/dist/task-card.js
...
COMPONENT_STYLESHEET10.replaceSync(selectable_items_default);
...
var COMPONENT_TAG_NAME10 = "selectable-items";
...
if (customElements.get(COMPONENT_TAG_NAME10) == null) {
  customElements.define(COMPONENT_TAG_NAME10, SelectableItemsElement);
}
...
COMPONENT_STYLESHEET11.replaceSync(collection_filter_default);
var COMPONENT_TAG_NAME11 = "collection-filter";
...
if (customElements.get(COMPONENT_TAG_NAME11) == null) {
  customElements.define(COMPONENT_TAG_NAME11, CollectionFilterElement);
}
...
COMPONENT_STYLESHEET12.replaceSync(captioned_thumbnail_default);
var COMPONENT_TAG_NAME12 = "captioned-thumbnail";
...
if (customElements.get(COMPONENT_TAG_NAME12) == null) {
  customElements.define(COMPONENT_TAG_NAME12, CaptionedThumbnailElement);
}

// node_modules/.pnpm/@magnit-ce+file-input@0.0.3/node_modules/@magnit-ce/file-input/dist/file-input.js
var file_input_default = '\n:host \n{ \n    display: inline-grid;\n    grid-template-columns: 1fr auto;\n    gap: .25em;\n    min-height: 34px;\n\n    /* user-agent input defaults */\n    --border-color: rgb(118, 118, 118);\n\n    /* slotted elements can inherit this for easy color matching */\n    --placeholder-color: #757575;\n}\n@media (prefers-color-scheme: dark) \n{\n    :host\n    {\n      --border-color: rgb(133, 133, 133);\n    }\n}\n\n/* block styles */\n:host(.block)\n{\n    grid-template-columns: 1fr 1fr;\n}\n:host(.block) [part="label"]\n{\n    grid-column: span 2;\n    grid-row: 1;\n}\n:host(.block) [part="field"]\n{\n    border: dashed 1px #666;\n    display: grid;\n    gap: .5em;\n    justify-items: center;\n}\n:host(.block) [part="icon"]\n{\n    font-size: 3em;\n}\n:host(.block) [part="clear"]\n{\n    grid-column: 1;\n    grid-row: 2;\n}\n:host(.block) [part="view-link"]\n{\n    grid-column: 2;\n    grid-row: 2;\n    justify-self: flex-end;\n}\n/* end block styles */\n\ninput\n{\n    display: none;\n}\n\n[part="label"]\n{\n    flex: 1;\n    display: flex;\n    grid-row: span 2;\n    grid-column: 1;\n}\n\n[part="field"]\n{\n    flex: 1;\n    white-space: nowrap;\n\n    box-sizing: border-box;\n    display: inline-flex;\n    align-items: center;\n    gap: .25em;\n    padding: .25em .5em;\n    min-width: 177px;\n\n    background-color: field;\n    color: fieldtext;\n\n    font-size: 13.33px;\n    border-width: 1px;\n    border-style: solid;\n    border-color: var(--border-color);\n    border-radius: 2px;\n    overflow: hidden;\n\n}\n[part="field"]:focus-visible\n,[part="field"]:focus\n{\n    outline: solid 2px;\n    border-radius: 3px;\n}\n\n[part="view-link"][href="#"]\n{\n    display: none;\n}\n[part="view-link"]\n{\n    white-space: nowrap;\n    font-size: .75em;\n    grid-column: 2;\n    grid-row: 2;\n    align-self: center;\n}\n\n[part="placeholder"]\n,[part="icon"]\n,::slotted([slot="placeholder"])\n,::slotted([slot="icon"])\n{\n    color: var(--placeholder-color);\n}\n:host([specified]) [part="placeholder"]\n,:host([specified]) ::slotted([slot="placeholder"])\n{\n    display: none;\n}\n\n[part="clear"]\n{\n    display: none;\n    white-space: nowrap;\n    font-size: .75em;\n    grid-column: 2;\n    grid-row: 1;\n    align-self: center;\n}\n:host([specified]) [part="clear"]\n{\n    display: block;\n}';
var file_input_default2 = '<label part="label" tabindex="0">\n    <input type="file" part="input" />\n    <span part="field">\n        <slot name="icon"><span part="icon">\u{1F5CE}</span></slot>\n        <span part="status">\n            <span part="filename"></span>\n            <slot name="placeholder"><span part="placeholder"></span></slot>\n        </span>\n    </span>\n</label>\n<a href="" part="clear" tabindex="0"><slot name="clear">Clear Selection</slot></a>\n<a href="#" target="_blank" part="view-link" tabindex="0"><slot name="view-link">View Document</slot></a>';
var COMPONENT_STYLESHEET13 = new CSSStyleSheet();
COMPONENT_STYLESHEET13.replaceSync(file_input_default);
var COMPONENT_TAG_NAME13 = "file-input";
var FileInputElement = class extends HTMLElement {
  componentParts = /* @__PURE__ */ new Map();
  getPart(key) {
    if (this.componentParts.get(key) == null) {
      const part = this.shadowRoot.querySelector(`[part="${key}"]`);
  ...
  constructor() {
    ...
    this.attachShadow({ mode: "open" });
    this.shadowRoot.innerHTML = file_input_default2;
    this.shadowRoot.adoptedStyleSheets.push(COMPONENT_STYLESHEET13);
    const placeholderLabel = this.findPart("placeholder");
...
if (customElements.get(COMPONENT_TAG_NAME13) == null) {
  customElements.define(COMPONENT_TAG_NAME13, FileInputElement);
}

// node_modules/.pnpm/@magnit-ce+image-input@0.0.3/node_modules/@magnit-ce/image-input/dist/image-input.js
...
COMPONENT_STYLESHEET14.replaceSync(image_input_default);
var COMPONENT_TAG_NAME14 = "image-input";
...
if (customElements.get(COMPONENT_TAG_NAME14) == null) {
  customElements.define(COMPONENT_TAG_NAME14, ImageInputElement);
}

// node_modules/.pnpm/@magnit-ce+form-field@0.0.3/node_modules/@magnit-ce/form-field/dist/form-field.js
...
// node_modules/.pnpm/@magnit-ce+record-tree@0.0.2/node_modules/@magnit-ce/record-tree/dist/record-tree.js
...
function daysToPersist_onChange(event) {
...
function deletedItems_onRemove(event) {
...
function deletedImages_onRemove(event) {
  const item = event.detail;
...
function history_undo_onClick(_event) {
  this.undo();
}
function history_redo_onClick(_event) {
  this.redo();
}
async function actionHistory_onBack(target, previous, all, targetIndex, previousActiveEntryIndex) {
...
async function actionHistory_onForward(target, previous, all, targetIndex, previousActiveEntryIndex) {
...
function clearHistory_onClick(_event) {
  this.clearHistory();
}
function recentBoard_onRemove(event) {
...
function board_edit_onClick(event) {
  const data = event.detail;
  const target = data;
...
function taskBoard_onChange(event) {
  const data = event.detail;
  console.log(data);
}
function taskBoard_onListCollapse(event) {
}
async function taskBoard_onTaskAdd(event) {
...
function taskBoard_onTaskRemove(event) {
...
function boardsList_onDragover(event) {
  event.preventDefault();
  event.stopPropagation();
  this[SHAREDACCESSKEY].updateBoardItemOrder(event.clientY);
}
async function boardsList_onDrop(_event) {
...
async function boardSettings_ok_onClick(event) {
...
function addList_onClick(event) {
  this.addList();
}
function list_onDuplicate(event) {
  const data = event.detail;
...
COMPONENT_STYLESHEET18.replaceSync(`${menu_default}
...
var TaskboardManagerElement7 = class extends HTMLElement {
  ...
  */
  ...
  async #init() {
    ...
    this.#refreshDeletedItems();
    const { windowPath, windowHash } = parseWindowPath();
    await this.getPart("app-router").navigate(windowPath + windowHash);
  ...
  async #updateBoardSettings() {
    ...
    const boardItem = boards.querySelector(`a[path*="${board.id}"]`);
    if (boardItem == null) {
      MessageCardElement.notify(
        `An error occurred saving a task board.`,
        this.getPart("notifications"),
  ...
  async #openImportManager(data) {
    ...
    this.findPart("app-router").navigate("#import");
...
if (customElements.get(COMPONENT_TAG_NAME19) == null) {
  customElements.define(COMPONENT_TAG_NAME19, TaskboardManagerElement7);
}
export {
  AppSettingKey,
  SHAREDACCESSKEY,
  TaskboardManagerElement7 as TaskboardManagerElement
};
