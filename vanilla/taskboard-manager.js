...
// node_modules/.pnpm/@magnit-ce+collection-filter@0.0.7/node_modules/@magnit-ce/collection-filter/dist/collection-filter.js
...
function router_onPathChange(event) {
  ...
  if (hashRoute != null) {
    ...
    configPanel.findElement("config-navigation").querySelector(`[data-route="#${hashRoute}"]`)?.setAttribute("aria-current", "page");
