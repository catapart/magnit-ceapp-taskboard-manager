...
# The `taskboard-manager` Custom Element
...
|||||
|-|-|-|-|
|Package size, **verbose**:|~577kb|Package size, **minified**:|~454kb|
...
### Documentation:
https://catapart.github.io/magnit-ceapp-taskboard-manager/docs
### Automated Testing:
https://catapart.github.io/magnit-ceapp-taskboard-manager/tests.html
